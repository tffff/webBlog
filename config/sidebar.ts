  ...
  '/myblog': [
    ...
    },
    {
      ...
      children: [
        ...
        { title: 'Docker 的命令使用', link: '/myblog/docker' },
        { title: '前端插件', link: '/myblog/plugins' },
        { title: '水波纹效果', link: '/myblog/animate' },
        { title: 'Js 工具类 Utils', link: '/myblog/jsutils' },
        { title: 'VsCode 技巧', link: '/myblog/vscode' },
        { title: 'Gitlab CI/CD', link: '/myblog/gitlab' },
  ...
  '/aiapp': [
    {
      ...
      children: [
        ...
        { title: 'Langchain', link: '/aiapp/langchain' },
        { title: 'Langgraph', link: '/aiapp/langgraph' },
        { title: 'Function Call', link: '/aiapp/functioncall' },
        { title: 'RAG 检索增强', link: '/aiapp/rag' },
